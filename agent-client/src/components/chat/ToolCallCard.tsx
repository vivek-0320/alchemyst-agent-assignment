...
function ToolCallCard({ toolBlock, isHighlighted, onSelect }: {
  ...
  return (
    <div onClick={() => onSelect(toolBlock.id)} className={`${isHighlighted ? "ring-2 ring-blue-400" : ""} bg-white/60 border border-gray-200/60 rounded-xl p-3 text-sm font-mono overflow-x-auto text-gray-700`}>
